...
/**
 * This is the item provider adapter for a {@link sml.Literal} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SmlPackage.Literals.LITERAL__VALUE,
				 true,
				 false,
				 false,
	...
	protected void addDataTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Literal_dataType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Literal_dataType_feature", "_UI_Literal_type"),
				 SmlPackage.Literals.LITERAL__DATA_TYPE,
				 true,
				 false,
				 true,
				 null,
