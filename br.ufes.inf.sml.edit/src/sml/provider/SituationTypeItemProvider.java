...
/**
 * This is the item provider adapter for a {@link sml.SituationType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SituationTypeItemProvider
	 ...
	 * @generated
	 */
	public SituationTypeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SituationType_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SituationType_name_feature", "_UI_SituationType_type"),
				 SmlPackage.Literals.SITUATION_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns SituationType.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SituationType"));
	}
	...
	public String getText(Object object) {
		String label = ((SituationType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SituationType_type") :
			getString("_UI_SituationType_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SituationType.class)) {
