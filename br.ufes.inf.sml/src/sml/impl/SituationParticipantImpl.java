...
public class SituationParticipantImpl extends ParticipantImpl implements SituationParticipant {
	...
	protected EClass eStaticClass() {
		return SmlPackage.Literals.SITUATION_PARTICIPANT;
	}
		...
		if (situationType != null && situationType.eIsProxy()) {
			...
			if (situationType != oldSituationType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SmlPackage.SITUATION_PARTICIPANT__SITUATION_TYPE, oldSituationType, situationType));
			}
		}
	...
	public void setSituationType(SituationType newSituationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmlPackage.SITUATION_PARTICIPANT__SITUATION_TYPE, oldSituationType, situationType));
	}
	...
	public EList<SituationParameterReference> getParameter() {
		if (parameter == null) {
			parameter = new EObjectWithInverseResolvingEList<SituationParameterReference>(SituationParameterReference.class, this, SmlPackage.SITUATION_PARTICIPANT__PARAMETER, SmlPackage.SITUATION_PARAMETER_REFERENCE__SITUATION);
		}
		return parameter;
	}
	...
	public void setIsPast(boolean newIsPast) {
		...
		isPast = newIsPast;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmlPackage.SITUATION_PARTICIPANT__IS_PAST, oldIsPast, isPast));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SmlPackage.SITUATION_PARTICIPANT__SITUATION_TYPE:
