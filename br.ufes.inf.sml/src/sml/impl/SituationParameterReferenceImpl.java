 ...
 * <ul>
 *   <li>{@link sml.impl.SituationParameterReferenceImpl#getParameter <em>Parameter</em>}</li>
 *   <li>{@link sml.impl.SituationParameterReferenceImpl#getSituation <em>Situation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SituationParameterReferenceImpl extends NodeImpl implements SituationParameterReference {
	...
	protected EClass eStaticClass() {
		return SmlPackage.Literals.SITUATION_PARAMETER_REFERENCE;
	}
		...
		if (parameter != null && parameter.eIsProxy()) {
			...
			if (parameter != oldParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SmlPackage.SITUATION_PARAMETER_REFERENCE__PARAMETER, oldParameter, parameter));
			}
		}
		return parameter;
	}
	...
	public void setParameter(SituationTypeParameter newParameter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmlPackage.SITUATION_PARAMETER_REFERENCE__PARAMETER, oldParameter, parameter));
	}
	...
	public SituationParticipant getSituation() {
		if (situation != null && situation.eIsProxy()) {
			...
			if (situation != oldSituation) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SmlPackage.SITUATION_PARAMETER_REFERENCE__SITUATION, oldSituation, situation));
			}
		}
		return situation;
	}
	...
	public NotificationChain basicSetSituation(SituationParticipant newSituation, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SmlPackage.SITUATION_PARAMETER_REFERENCE__SITUATION, oldSituation, newSituation);
	...
	public void setSituation(SituationParticipant newSituation) {
		if (newSituation != situation) {
			...
			if (situation != null)
				msgs = ((InternalEObject)situation).eInverseRemove(this, SmlPackage.SITUATION_PARTICIPANT__PARAMETER, SituationParticipant.class, msgs);
			if (newSituation != null)
				msgs = ((InternalEObject)newSituation).eInverseAdd(this, SmlPackage.SITUATION_PARTICIPANT__PARAMETER, SituationParticipant.class, msgs);
			msgs = basicSetSituation(newSituation, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmlPackage.SITUATION_PARAMETER_REFERENCE__SITUATION, newSituation, newSituation));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SmlPackage.SITUATION_PARAMETER_REFERENCE__SITUATION:
				if (situation != null)
					msgs = ((InternalEObject)situation).eInverseRemove(this, SmlPackage.SITUATION_PARTICIPANT__PARAMETER, SituationParticipant.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SmlPackage.SITUATION_PARAMETER_REFERENCE__PARAMETER:
