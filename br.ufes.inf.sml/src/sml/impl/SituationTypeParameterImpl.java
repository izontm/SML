 ...
 * <ul>
 *   <li>{@link sml.impl.SituationTypeParameterImpl#getNodeReference <em>Node Reference</em>}</li>
 *   <li>{@link sml.impl.SituationTypeParameterImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SituationTypeParameterImpl extends EObjectImpl implements SituationTypeParameter {
	/**
	...
	protected EClass eStaticClass() {
		return SmlPackage.Literals.SITUATION_TYPE_PARAMETER;
	}
	...
	public void setNodeReference(ExportableNode newNodeReference) {
		if (newNodeReference != nodeReference) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SmlPackage.SITUATION_TYPE_PARAMETER__NODE_REFERENCE, newNodeReference, newNodeReference));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmlPackage.SITUATION_TYPE_PARAMETER__NAME, oldName, name));
	}
