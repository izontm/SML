 ...
 * <ul>
 *   <li>{@link sml.impl.ExistsSituationImpl#isIsNegated <em>Is Negated</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ExistsSituationImpl extends SituationParticipantImpl implements ExistsSituation {
	...
	protected EClass eStaticClass() {
		return SmlPackage.Literals.EXISTS_SITUATION;
	}
	...
	public void setIsNegated(boolean newIsNegated) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmlPackage.EXISTS_SITUATION__IS_NEGATED, oldIsNegated, isNegated));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SmlPackage.EXISTS_SITUATION__IS_NEGATED:
				return isIsNegated();
		}
