 ...
 * <ul>
 *   <li>{@link sml.impl.ExportableNodeImpl#getNodeParameter <em>Node Parameter</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ExportableNodeImpl extends NodeImpl implements ExportableNode {
	...
	protected EClass eStaticClass() {
		return SmlPackage.Literals.EXPORTABLE_NODE;
	}
		...
		if (nodeParameter != null && nodeParameter.eIsProxy()) {
			...
			if (nodeParameter != oldNodeParameter) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SmlPackage.EXPORTABLE_NODE__NODE_PARAMETER, oldNodeParameter, nodeParameter));
			}
		}
	...
	public NotificationChain basicSetNodeParameter(SituationTypeParameter newNodeParameter, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SmlPackage.EXPORTABLE_NODE__NODE_PARAMETER, oldNodeParameter, newNodeParameter);
	...
	public void setNodeParameter(SituationTypeParameter newNodeParameter) {
		if (newNodeParameter != nodeParameter) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SmlPackage.EXPORTABLE_NODE__NODE_PARAMETER, newNodeParameter, newNodeParameter));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SmlPackage.EXPORTABLE_NODE__NODE_PARAMETER:
				if (nodeParameter != null)
					msgs = ((InternalEObject)nodeParameter).eInverseRemove(this, SmlPackage.SITUATION_TYPE_PARAMETER__NODE_REFERENCE, SituationTypeParameter.class, msgs);
