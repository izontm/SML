...
public class SmlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case SmlPackage.SITUATION_TYPE_ELEMENT: {
			...
			case SmlPackage.EXPORTABLE_NODE: {
			...
			case SmlPackage.ENTITY_PARTICIPANT: {
			...
			case SmlPackage.RELATOR_PARTICIPANT: {
			...
			case SmlPackage.SITUATION_TYPE_PARAMETER: {
			...
			case SmlPackage.ATTRIBUTE_REFERENCE: {
			...
			case SmlPackage.SITUATION_PARAMETER_REFERENCE: {
